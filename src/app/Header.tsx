...
export default function Header({ }: Props) {
    ...
    useEffect(() => {
        ...
        const handleClickOutside = (e: MouseEvent) => {
            if (isSearchOpen && (modalRef.current && !modalRef.current.contains(e.target as Node)) && !searchRef?.current?.contains(e.target as Node)) {
                setIsSearchOpen(false);
            }
        };
    ...
    return (
        <>
            ...
            {
                isSearchOpen &&
                <DocsViewerSearch modalRef={modalRef} setIsSearchOpen={setIsSearchOpen} />
            }
        </>
    )
}