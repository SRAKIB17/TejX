    ...
    if (dx) {
        ...
        return <section className='p-4'>
            ...
            <div className="flex items-center justify-center pt-5 pb-4 gap-4">
                ...
                {
                    prev?.path &&
                    <Link className="btn btn-outline hover:border-primary rounded-md btn-sm h-10 capitalize hover:bg-primary hover:text-white" href={`/${prev.path}`}>
                        <span>
                            <IoIosArrowBack />
                        </span>
                        <span>
                ...
                {
                    next?.path &&
                    <Link className="btn btn-outline hover:border-primary rounded-md btn-sm h-10 capitalize hover:bg-primary hover:text-white" href={`/${next.path}`}>
                        <span>
                            {next?.name}
                        </span>
                        <span>
